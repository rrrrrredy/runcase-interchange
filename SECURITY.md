...
Report schema or CLI vulnerabilities privately through the repository's [security advisory form](https://github.com/rrrrrredy/runcase-interchange/security/advisories/new). Do not attach real Run exports, credentials, proprietary task data, or private content-store objects. Use synthetic examples.
